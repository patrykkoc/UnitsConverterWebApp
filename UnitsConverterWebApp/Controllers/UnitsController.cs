...
namespace UnitsConverterWebApp.Controllers
{
    public class UnitsController : Controller
    {
        ...
        {
            var unitsWithCategories = _context.Units.Include(u => u.Category);

            return View(await unitsWithCategories.ToListAsync());
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Symbol,Category,MultiplierToBase,OffsetToBase,IsBaseUnit")] Unit unit)
        {
            if (id != unit.Id)
            {
                return NotFound();
